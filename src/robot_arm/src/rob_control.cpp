...
namespace rob_robots{
	...
	void rob_control::init(){
		...
		r_msgJointsCurrent.name[0] ="joint1";
		r_msgJointsCurrent.position[0] = 0.0;
		r_msgJointsCurrent.name[1] ="joint2";
		r_msgJointsCurrent.position[1] = 0.0;
        r_msgJointsCurrent.name[2] ="joint3";
		r_msgJointsCurrent.position[2] = 0.0;
        r_msgJointsCurrent.name[3] ="joint4";
		r_msgJointsCurrent.position[3] = 0.0;
		r_msgJointsCurrent.name[4] ="joint5";
		...
		l_msgJointsCurrent.name[0] ="joint1";
		l_msgJointsCurrent.position[0] = 0.0;
		l_msgJointsCurrent.name[1] ="joint2";
		l_msgJointsCurrent.position[1] = 0.0;
        l_msgJointsCurrent.name[2] ="joint3";
		l_msgJointsCurrent.position[2] = 0.0;
        l_msgJointsCurrent.name[3] ="joint4";
		l_msgJointsCurrent.position[3] = 0.0;
		l_msgJointsCurrent.name[4] ="joint5";
